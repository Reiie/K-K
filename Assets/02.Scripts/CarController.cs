...
using UnityEngine;
    ...
    {
        csCarState CARSTATE;
        [SerializeField] public bool AccelControl = false;
	...
	void Update()
	{
		if (MAG_Trigger == false) 
		{
			MAGNITUDE = m_Rigidbody.velocity.magnitude;
		} 
		else if (MAG_Trigger == true) 
		{
		...
		//Debug.Log ("X = " + m_Rigidbody.velocity.x + "/ Y = " + m_Rigidbody.velocity.y + "/ Z = " + m_Rigidbody.velocity.z );
